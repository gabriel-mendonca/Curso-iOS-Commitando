...
final class CacheServiceTests: XCTestCase {
    ...
    func test_load_retured_same_empty_cache_for_called_twice() {
        let sut = makeSUT()
    ...
    func test_load_returned_data_after_insert_data() {
        let sut = makeSUT()
    ...
    private func assert(_ sut: CacheClient,
                        ...
                        line: UInt = #line)
    {
        ...
        sut.load { returnedResult in
            ...
            case let (.success(items, timestamp), .success(items: returnedItems, timestamp: returnedTimestamp)):
